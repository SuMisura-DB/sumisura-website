            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="article-title-input" name="article-title" placeholder="Enter project title">
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="article-img">Imagem Principal</label>
                        <input class="form-control" id="article-img" name="article-img" type="file"
                    ...
                    <div class="mb-3">
                        ...
                        {{-- Content --}}
                        <textarea class="ckeditor" name="content" placeholder="Conteúdo"></textarea>
