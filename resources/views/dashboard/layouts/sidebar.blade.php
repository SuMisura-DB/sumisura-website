            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            {{-- Geral --}}
                            <li class="nav-item">
                                <a href="{{ route('dashboard.index') }}" class="nav-link">Geral</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarBlog" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-pages-line"></i> <span>Blog</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarBlog">
                        <ul class="nav nav-sm flex-column">
                            ...
                            {{-- Visualize --}}
                            <li class="nav-item">
                                <a href="{{ route('dashboard.blog_list') }}" class="nav-link">Ver Artigos</a>
                            </li>
